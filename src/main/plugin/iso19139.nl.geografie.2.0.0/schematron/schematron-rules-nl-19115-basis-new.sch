...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  <sch:title xmlns="http://www.w3.org/2001/XMLSchema">Validatie tegen het Nederlands metadata profiel op ISO 19115 voor geografie versie 2.1.0 (2020)</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:fileIdentifier">
      ...
      <sch:let name="fileIdentifier" value="normalize-space(gco:CharacterString)"/>

      <sch:assert id="Metadata_ID" etf_name="Metadata ID" test="$fileIdentifier" see="https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#metadata-unieke-identifier">$loc/strings/fileIdentifier</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:language">
      ...
      <sch:let name="mdLanguage" value="(*/@codeListValue = 'dut' or gmd:language/*/@codeListValue = 'eng')"/>
      <sch:let name="mdLanguage_value" value="string(*/@codeListValue)"/>

      <sch:assert test="$mdLanguage">$loc/strings/metadataLanguage</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:hierarchyLevel[1]">
      ...
      <sch:let name="hierarchyLevel" value="(*/@codeListValue = 'dataset' or gmd:hierarchyLevel[1]/*/@codeListValue = 'series')"/>
      <sch:let name="hierarchyLevel_value" value="string(*/@codeListValue)"/>
      ...
      <sch:let name="hierarchyLevelName" value="normalize-space(gco:CharacterString)"/>

      <sch:assert id="Metadata_hierarchieniveau" etf_name="Metadata_hierarchieniveau" test="$hierarchyLevel" see="https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#hi%C3%ABrarchieniveau">$loc/strings/hierarchyLevel</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:contact[1]">
      ...
      <sch:let name="mdResponsibleParty_OrganisationString" value="normalize-space(gmd:CI_ResponsibleParty/gmd:organisationName/gco:CharacterString)"/>
      <sch:let name="mdResponsibleParty_OrganisationURI" value="normalize-space(gmd:CI_ResponsibleParty/gmd:organisationName/gmx:Anchor/@xlink:href)"/>
      <sch:let name="mdResponsibleParty_OrganisationAnchorLabel" value="normalize-space(gmd:CI_ResponsibleParty/gmd:organisationName/gmx:Anchor)"/>
      ...
      <sch:let name="mdResponsibleParty_Mail" value="normalize-space(gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:address/gmd:CI_Address/gmd:electronicMailAddress[1]/gco:CharacterString)"/>
      <!--  voor INSPIRE toegestane waarde in combi met INSPIRE specificatie -->
      <sch:let name="mdResponsibleParty_Role_INSPIRE" value="gmd:CI_ResponsibleParty/gmd:role/*/@codeListValue = 'pointOfContact' "/>

      <sch:assert id="Naam_organisatie_metadata_ISO_nr_376" etf_name="Naam organisatie metadata (ISO nr. 376)" test="$mdResponsibleParty_OrganisationString or ($mdResponsibleParty_OrganisationURI and $mdResponsibleParty_OrganisationAnchorLabel)">$loc/strings/contactOrganisationName</sch:assert>
      ...
      <sch:assert id="INSPIRE_Rol_organisatie_metadata_ISO_nr_379" etf_name="INSPIRE Rol organisatie metadata (ISO nr. 379)" test="not($conformity_Spec_Title_Exsists) or ($conformity_Spec_Title_Exsists and $mdResponsibleParty_Role_INSPIRE)">$loc/strings/contactRolINSPIRE</sch:assert>
      <!-- eind INSPIRE in combi met specificatie INSPIRE -->
      <sch:assert id="E-mail_organisatie_metadata_ISO_nr_386" etf_name="E-mail organisatie metadata (ISO nr. 386)"  test="$mdResponsibleParty_Mail">$loc/strings/contactEmail</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:dateStamp">
      ...
      <sch:let name="dateStamp" value="normalize-space(string(gco:Date))"/>

      <sch:assert id="Metadata_datum_ISO_nr_9" etf_name="Metadata datum (ISO nr. 9)" test="((number(substring(substring-before($dateStamp,'-'),1,4)) &gt; 1000 ))">$loc/strings/dateStamp</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:metadataStandardName">
      ...
      <sch:let name="metadataStandardName" value="translate(normalize-space(gco:CharacterString), $lowercase, $uppercase)"/>

      <sch:assert id="Metadatastandaard_naam_ISO_nr_10" etf_name="Metadatastandaard naam (ISO nr. 10)" test="$metadataStandardName = 'ISO 19115'">$loc/strings/metadataStandardName</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:metadataStandardVersion">
      ...
      <sch:let name="metadataStandardVersion" value="translate(normalize-space(gco:CharacterString), $lowercase, $uppercase)"/>

      <sch:assert id="Versie_metadatastandaard_ISO_nr_11" etf_name="Versie metadatastandaard (ISO nr. 11)" test="contains($metadataStandardVersion, 'PROFIEL OP ISO 19115')">$loc/strings/metadataStandardVersion</sch:assert>
    ...
    <!-- Referentiesysteem  -->
    <sch:rule context="/gmd:MD_Metadata/gmd:referenceSystemInfo">
      <!-- reference system  -->
      <sch:let name="referenceSystemInfo" value="."/>

      <sch:assert id="Code_referentiesysteem_ISO_nr_207" etf_name="Code referentiesysteem (ISO nr. 207)" test="$referenceSystemInfo">$loc/strings/referenceSystemCode</sch:assert>
    </sch:rule>

    <sch:rule context="/gmd:MD_Metadata/gmd:referenceSystemInfo/gmd:MD_ReferenceSystem/gmd:referenceSystemIdentifier/gmd:RS_Identifier/gmd:code">
      <!--  Ruimtelijk referentiesysteem  https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#codereferentiesysteem -->
      <!-- RS_Identifier -->
      <sch:let name="referenceSystemInfo_CodeString" value="normalize-space(gco:CharacterString)"/>
      <sch:let name="referenceSystemInfo_CodeURI" value="normalize-space(gmx:Anchor[string-length(normalize-space(string-join(text(), ''))) > 0]/@xlink:href)"/>

      <sch:assert id="Code_referentiesysteem_ISO_nr_207_2" etf_name="Code referentiesysteem (ISO nr. 207)" test="$referenceSystemInfo_CodeString or $referenceSystemInfo_CodeURI">$loc/strings/referenceSystemCodeURI</sch:assert>
  ...
  <!--- Dataset information pattern -->
  <sch:pattern>
    <sch:title>Dataset information</sch:title>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:title">
      <!-- Dataset titel, https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#titel-van-de-bron -->
      <sch:let name="datasetTitle" value="normalize-space(gco:CharacterString)"/>

      <sch:assert id="Dataset_titel_ISO_nr_360" etf_name="Dataset titel (ISO nr. 360)" test="$datasetTitle">$loc/strings/datasetTitle</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation">
      ...
      <sch:let name="publicationDateString" value="string(*[./gmd:CI_Date/gmd:dateType/*/@codeListValue='publication']/gmd:CI_Date/gmd:date/gco:Date)"/>
      <sch:let name="creationDateString" value="string(*[./gmd:CI_Date/gmd:dateType/*/@codeListValue='creation']/gmd:CI_Date/gmd:date/gco:Date)"/>
      <sch:let name="revisionDateString" value="string(*[./gmd:CI_Date/gmd:dateType/*/@codeListValue='revision']/gmd:CI_Date/gmd:date/gco:Date)"/>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:abstract">
      ...
      <sch:let name="abstract" value="normalize-space(gco:CharacterString)"/>

      <!-- 5.2.5 Samenvatting https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#samenvatting -->
      <sch:assert id="Samenvatting_ISO_nr_25" etf_name="Samenvatting (ISO nr. 25)" test="$abstract">$loc/strings/datasetAbstract</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:pointOfContact[1]">
      ...
      <sch:let name="responsibleParty_OrganisationString" value="normalize-space(gmd:CI_ResponsibleParty/gmd:organisationName/gco:CharacterString)"/>
      <sch:let name="responsibleParty_OrganisationURI" value="normalize-space(gmd:CI_ResponsibleParty/gmd:organisationName/gmx:Anchor/@xlink:href)"/>
      <sch:let name="responsibleParty_OrganisationAnchor" value="normalize-space(gmd:CI_ResponsibleParty/gmd:organisationName/gmx:Anchor)"/>
      ...
      <sch:let name="responsibleParty_Mail" value="normalize-space(gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:address[1]/gmd:CI_Address/gmd:electronicMailAddress[1]/gco:CharacterString)"/>
      ...
      <sch:let name="responsibleParty_Role" value="gmd:pointOfContact[1]/gmd:CI_ResponsibleParty/gmd:role/*[@codeListValue = 'resourceProvider' or @codeListValue = 'custodian' or @codeListValue = 'owner' or @codeListValue = 'user' or @codeListValue = 'distributor' or @codeListValue = 'owner' or @codeListValue = 'originator' or @codeListValue = 'pointOfContact' or @codeListValue = 'principalInvestigator' or @codeListValue = 'processor' or @codeListValue = 'publisher' or @codeListValue = 'author']"/>

      <sch:assert id="Verantwoordelijke_organisatie_bron_ISO_nr_376" etf_name="Verantwoordelijke organisatie bron (ISO nr. 376)" test="$responsibleParty_OrganisationString or $responsibleParty_OrganisationURI">$loc/strings/datasetPointOfContactOrganisationName</sch:assert>
      ...
      <sch:assert id="Rol_verantwoordelijke_organisatie_bron_ISO_nr_379" etf_name="Rol verantwoordelijke organisatie bron (ISO nr. 379)" test="$responsibleParty_Role">$loc/strings/datasetPointOfContactRol</sch:assert>
      ...
      <sch:assert id="E-mail_verantwoordelijke_organisatie_bron_ISO_nr_386" etf_name="E-mail verantwoordelijke organisatie bron (ISO nr. 386)" test="$responsibleParty_Mail">$loc/strings/datasetPointOfContactEmail</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier/gmd:code">
      <!-- 5.2.4 Unieke Identifier van de bron, https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#unieke-identifier-van-de-bron -->
      <sch:let name="identifierString" value="normalize-space(string-join(*/text(), ''))"/>
      ...
      <!-- Het gebuik van een URI is conditioneel, het is verplicht voor INSPIRE datasets? -> nog inbouwen om te detecteren of het INSPIRE data betreft of doen we dat net als met de oude versie van het profiel in een aparte validator?
       -->
      <sch:let name="identifierURI" value="normalize-space(gmx:Anchor/@xlink:href)"/>

      <!-- 5.2.4 Unieke Identifier van de bron https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#unieke-identifier-van-de-bron -->
      <sch:assert id="Unieke_Identifier_van_de_bron_ISO_nr_207" etf_name="Unieke Identifier van de bron (ISO nr. 207)" test="$identifierString">$loc/strings/datasetUniqueIdentifier</sch:assert>
      ...
      <!-- 5.2.4 Unieke Identifier van de bron https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#unieke-identifier-van-de-bron met een URI, dan beginnen met HTTP-->
      <sch:assert id="Unieke_Identifier_van_de_bron_ISO_nr_207_URI" etf_name="Unieke Identifier van de bron (ISO nr. 207)" test=" not($identifierURI) or ($identifierURI and starts-with($identifierURI, 'http'))">$loc/strings/datasetUniqueIdentifierURI</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:language">
      ...
      <sch:let name="language" value="(*/@codeListValue = 'dut' or gmd:identificationInfo/gmd:MD_DataIdentification/gmd:language/*/@codeListValue = 'eng')"/>
      <sch:let name="language_value" value="string(*/@codeListValue)"/>

      <!-- v.2.1.0: taal van de bron is verplicht geworden: dus niet op testen als assertion -->
      <sch:assert id="Taal_van_de_bron_ISO_nr_39" etf_name="Taal van de bron (ISO nr. 39)" test="$language">$loc/strings/datasetLanguage</sch:assert>
    </sch:rule>

    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:topicCategory/gmd:MD_TopicCategoryCode">
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:extent/gmd:EX_Extent/gmd:geographicElement[1]">
      <sch:let name="west" value="number(gmd:EX_GeographicBoundingBox/gmd:westBoundLongitude/gco:Decimal)"/>
      <sch:let name="east" value="number(gmd:EX_GeographicBoundingBox/gmd:eastBoundLongitude/gco:Decimal)"/>
      <sch:let name="north" value="number(gmd:EX_GeographicBoundingBox/gmd:northBoundLatitude/gco:Decimal)"/>
      <sch:let name="south" value="number(gmd:EX_GeographicBoundingBox/gmd:southBoundLatitude/gco:Decimal)"/>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:resourceConstraints[2]">
      ...
      -->
      <sch:let name="otherConstraint1" value="normalize-space(string-join(gmd:MD_LegalConstraints/gmd:otherConstraints[1][gco:CharacterString or gmx:Anchor/@xlink:href]//text(), ''))"/>
      <sch:let name="otherConstraint2" value="normalize-space(string-join(gmd:MD_LegalConstraints/gmd:otherConstraints[2][gco:CharacterString or gmx:Anchor/@xlink:href]//text(), ''))"/>

      <sch:let name="otherConstraintURI1" value="gmd:MD_LegalConstraints/gmd:otherConstraints[1]/gmx:Anchor"/>
      <sch:let name="otherConstraintURI2" value="gmd:MD_LegalConstraints/gmd:otherConstraints[2]/gmx:Anchor"/>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:resourceConstraints[1]/gmd:MD_Constraints/gmd:useLimitation[1]">
      <!-- Gebruiksbeperkingen, https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#gebruiksbeperkingen -->
      <sch:let name="useLimitation" value="normalize-space(gco:CharacterString)"/>

      <sch:assert id="Gebruiksbeperkingen_ISO_nr_68" etf_name="Gebruiksbeperkingen (ISO nr. 68)" test="$useLimitation">$loc/strings/useLimitation</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:resourceConstraints[2]">
      ...
      <sch:let name="accessConstraints_value" value="normalize-space(gmd:MD_LegalConstraints/gmd:accessConstraints/*[@codeListValue = 'otherRestrictions']/@codeListValue)"/>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:identificationInfo/gmd:spatialResolution">
      <!-- spatial resolution -->
      <sch:let name="spatialResolution" value="."/>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords[1]/gmd:MD_Keywords/gmd:keyword[1]">
      <!-- 5.2.13 Trefwoord https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#trefwoord -->
      <sch:let name="keyword" value="normalize-space(string-join(*/text(), ''))"/>

      <sch:assert id="Trefwoorden_ISO_nr_53" etf_name="Trefwoorden (ISO nr. 53)" test="$keyword">$loc/strings/keyword</sch:assert>
    ...
    <!--<sch:rule id="Toepassingsschaal" etf_name="Toepassingsschaal" context="//gmd:spatialResolution/gmd:MD_Resolution/gmd:equivalentScale/gmd:MD_RepresentativeFraction/gmd:denominator/gco:Integer">
      ...
      <sch:assert id="Toepassingsschaal_ISO_nr_57" etf_name="Toepassingsschaal (ISO nr. 57)" test="not(string(number($denominator))='NaN')">$loc/strings/spatialResolutionDenominatorValue</sch:assert>
    ...
    <sch:rule id="Resolutie" etf_name="Resolutie" context="//gmd:spatialResolution/gmd:MD_Resolution/gmd:distance">

      <sch:let name="distance" value="gco:Distance/text()"/>
      <sch:let name="distance_UOM" value="gco:Distance/@uom= 'meters' "/>

      <sch:assert id="Resolutie_ISO_nr_61" etf_name="Resolutie (ISO nr. 61)" test="not(string(number($distance))='NaN')">$loc/strings/spatialResolutionDistance</sch:assert>
      ...
      <sch:assert id="Resolutie_ISO_nr_61_meeteenheid" etf_name="Resolutie (ISO nr. 61) meeteenheid" test="$distance_UOM" see="https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#resolutie">$loc/strings/spatialResolutionDistanceUnits</sch:assert>
    ...
    <sch:rule id="Resolutie_en_toepassingschaal" etf_name="Resolutie en toepassingschaal" context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:spatialResolution">
      <sch:let name="distance" value="gmd:MD_Resolution/gmd:distance/*/text()"/>
      <sch:let name="denominator" value="gmd:MD_Resolution/gmd:equivalentScale/gmd:MD_RepresentativeFraction/gmd:denominator/*/text()"/>

      <sch:assert id="Toepassingsschaal_ISO_nr_57_of_Resolutie_ISO_nr_61" etf_name="Toepassingsschaal (ISO nr. 57) of Resolutie (ISO nr. 61)" test="$denominator or $distance ">$loc/strings/spatialResolution</sch:assert>
    ...
    <!-- Spatial resolution equivalentScale https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#toepassingsschaal -->
    <sch:rule id="Toepassingsschaal" etf_name="Toepassingsschaal" context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:spatialResolution/gmd:MD_Resolution/gmd:equivalentScale/gmd:MD_RepresentativeFraction/gmd:denominator">
      <sch:let name="denominator" value="gco:Integer/text()"/>
      <sch:assert id="Toepassingsschaal_ISO_nr_57" etf_name="Toepassingsschaal (ISO nr. 57)" test="not(string(number($denominator))='NaN')">$loc/strings/spatialResolutionDenominator</sch:assert>
  ...
  <!--- Distribution information pattern -->
  <sch:pattern>
    <sch:title>Distribution information</sch:title>

    <sch:let name="conformity_Spec_Title11" value="normalize-space(string-join(//gmd:MD_Metadata/gmd:dataQualityInfo[1]/gmd:DQ_DataQuality/gmd:report[1]/gmd:DQ_DomainConsistency/gmd:result/gmd:DQ_ConformanceResult/gmd:specification/gmd:CI_Citation/gmd:title[./gco:CharacterString or ./gmx:Anchor]//text(), ''))"/>
    <sch:let name="conformity_Spec_Title21" value="normalize-space(string-join(//gmd:MD_Metadata/gmd:dataQualityInfo[1]/gmd:DQ_DataQuality/gmd:report[2]/gmd:DQ_DomainConsistency/gmd:result/gmd:DQ_ConformanceResult/gmd:specification/gmd:CI_Citation/gmd:title[./gco:CharacterString or ./gmx:Anchor]//text(), ''))"/>
    <sch:let name="conformity_Spec_Title31" value="normalize-space(string-join(//gmd:MD_Metadata/gmd:dataQualityInfo[1]/gmd:DQ_DataQuality/gmd:report[3]/gmd:DQ_DomainConsistency/gmd:result/gmd:DQ_ConformanceResult/gmd:specification/gmd:CI_Citation/gmd:title[./gco:CharacterString or ./gmx:Anchor]//text(), ''))"/>
    <sch:let name="conformity_Spec_Title41" value="normalize-space(string-join(//gmd:MD_Metadata/gmd:dataQualityInfo[1]/gmd:DQ_DataQuality/gmd:report[4]/gmd:DQ_DomainConsistency/gmd:result/gmd:DQ_ConformanceResult/gmd:specification/gmd:CI_Citation/gmd:title[./gco:CharacterString or ./gmx:Anchor]//text(), ''))"/>
    <sch:let name="conformity_Spec_Title_All1" value="concat(string($conformity_Spec_Title11),string($conformity_Spec_Title21),string($conformity_Spec_Title31),string($conformity_Spec_Title41))"/>
    <sch:let name="conformity_Spec_Title_Exsists1" value="contains($conformity_Spec_Title_All,'VERORDENING (EU) Nr. 1089/2010 VAN DE COMMISSIE van 23 november 2010 ter uitvoering van Richtlijn 2007/2/EG van het Europees Parlement en de Raad betreffende de interoperabiliteit van verzamelingen ruimtelijke gegevens en van diensten met betrekking tot ruimtelijke gegevens')"/>
  ...
  <!--- Data quality information pattern -->
  <sch:pattern>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:dataQualityInfo[1]">
      <sch:let name="levelCount" value="count(gmd:DQ_DataQuality/gmd:scope/gmd:DQ_Scope/gmd:level)" />
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:dataQualityInfo[1]/gmd:DQ_DataQuality/gmd:scope/gmd:DQ_Scope/gmd:level">
      <!--  Niveau kwaliteitsbeschrijving, https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#niveau-kwaliteitsbeschrijving -->
      <sch:let name="level" value="string(*/@codeListValue[. = 'dataset' or . = 'series'])"/>

      <sch:assert id="Niveau_kwaliteitsbeschrijving_ISO_nr139" etf_name="Niveau kwaliteitsbeschrijving (ISO nr.139)" test="$level">$loc/strings/dataQualityScope</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:dataQualityInfo[1]/gmd:DQ_DataQuality/gmd:lineage/gmd:LI_Lineage/gmd:statement">
      <!-- Algemene beschrijving herkomst, https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#algemene-beschrijving-herkomst  -->
      <sch:let name="statement" value="normalize-space(gco:CharacterString)"/>

      <sch:assert id="Algemene_beschrijving_herkomst_ISO_nr_83" etf_name="Algemene beschrijving herkomst (ISO nr. 83)" test="$statement">$loc/strings/dataQualityStatement</sch:assert>
    ...
    <sch:rule context="/gmd:MD_Metadata/gmd:dataQualityInfo[1]/gmd:DQ_DataQuality/gmd:report/gmd:DQ_DomainConsistency/gmd:result/gmd:DQ_ConformanceResult">
